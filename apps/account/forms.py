...
class AccountForm(forms.ModelForm):
    ...
    ACCOUNT_TYPE_CHOICES = [("Buyer", "Buyer"), ("Seller", "Seller")]
    ...
    def clean_first_name(self):
        first_name = (
            ...
            else forms.ValidationError("You must provide a first name for this account")
        )
        return first_name
    ...
    def clean_last_name(self):
        last_name = (
            ...
            else forms.ValidationError("You must provide a last name for this account")
        )
        return last_name
    ...
    def clean_phone(self):
        phone = (
            ...
            if self.cleaned_data.get("phone") is not None
            else forms.ValidationError(
                "You must provide a phoner number for this account"
            )
        )
        return phone
