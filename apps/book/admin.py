...
class BookResource(resources.ModelResource):
    ...
    def dehydrate_status(self, obj):
        ...
        rented_books = [
            {x.rented_customer.customer_username: statuses[x.rented_status]}
            for x in obj.rental_set.all()
        ]
        return rented_books
...
class CategoryBookModelAdmin(admin.ModelAdmin):
    list_display = ["category_book_name", "category_id"]


# register created custokm model to django admin site
admin.site.register(Book, BookModelAdmin)
admin.site.register(CategoryBook, CategoryBookModelAdmin)
